...
export type SaTransferType = {
   ...
   * @example
   * ```tsx
   * <SaTransfer onChange={({value, oldValue}) => { console.log(value, oldValue) }} />
   * ```
   * */
