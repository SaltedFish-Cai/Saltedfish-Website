  ...
  })()(
    {
      1: [
        function (require, module, exports) {
            ...
            const buildAttrs = function (attributes) {
              ...
              for (const name in attributes) {
                if (attributes.hasOwnProperty(name)) {
                  const value = typeof attributes[name] === "string" ? escapeHTML(attributes[name]) : "";
                  text += ` ${name}="${value}"`;
                }
              }
              return text;
          ...
          AvatarImage.prototype.getFontSize = function () {
            const textWidth = this.name.length * (this.name.charCodeAt(0) < 256 ? 0.75 : 1.5);
            const availableWidth = this.options.width || 32;

            let fontSize = Math.round(availableWidth / textWidth);
          ...
          AvatarImage.prototype.getBackgroundColor = function () {
            ...
            const bgColors = this.options.backgroundColors;
      ...
      2: [
        function (require, module, exports) {
          ...
          const AvatarImage = require("./image");
          const AvatarName = require("./name");
          /**
          ...
          namedavatar.setImg = function (img, fullName) {
            ...
            const svg = this.getSVG(fullName, options);
            const body = svg.outerHTML;
          ...
          namedavatar.getAvatarImage = function (fullName, tempOptions) {
            ...
            const avatarName = new AvatarName(fullName, options);
          ...
          namedavatar.getSVG = function (fullName, tempOptions) {
            const avatarImage = this.getAvatarImage(fullName, tempOptions);
      ...
      3: [
        function (require, module, exports) {
          ...
          AvatarName.prototype.getName = function () {
            ...
            const isASCII = fullName.charCodeAt(0) < 256;
            if (isASCII) {
